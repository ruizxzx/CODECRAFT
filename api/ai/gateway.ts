...
function schemaFor(task:string){
  ...
  const schemas:any={
    ...
    learning:{objectives:'string[]',concepts:'string[]',examples:'string[]',exercises:'string[]',questions:'string[]',quiz:'object[]',recap:'string'}, quiz:{questions:'object[]'}, flashcards:{cards:'object[]'}, prerequisites:{prerequisites:'object[]'},
    ...
    synthesize:{combinedUnderstanding:'string',conflictingClaims:'string[]',commonIdeas:'string[]',newInsights:'string[]',uncertainty:'string'}, creator:{improvements:'object'}
  };
