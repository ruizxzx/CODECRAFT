...
export interface SiteConfig {
  ...
  popupAnnouncement?: {
    ...
    startAt?: string;
    endAt?: string;
    targetPage?: 'all' | 'home' | 'blog' | 'article' | 'social' | 'explore' | 'series' | 'creator' | 'changelog' | 'learn' | 'knowledge' | 'vault' | 'research';
    targetRoute?: string;
    linkLabel?: string;
    linkTarget?: string;
    dismissible?: boolean;
...
export type PageView = 'purchases' | 'shop' | 'saved_products' | 'product' | 'home' | 'blog' | 'article' | 'about' | 'contact' | 'cms' | 'links' | 'community' | 'community_post' | 'community_profile' | 'question' | 'saved' | 'history' | 'notifications' | 'explore' | 'social' | 'series' | 'creator' | 'topic' | 'dashboard' | 'activity' | 'creator_studio' | 'creators' | 'preferences' | 'health' | 'changelog' | 'learn' | 'knowledge' | 'vault' | 'research';
