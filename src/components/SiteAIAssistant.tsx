...
export const SiteAIAssistant:React.FC<Props>=({open,onClose,articles,currentPage,currentContent,onNavigate,embedded=false})=>{
 ...
 return <div className={embedded ? "w-full" : "fixed inset-0 z-[110] bg-black/70 flex items-start justify-center p-4 sm:p-8 overflow-auto"} role="dialog" aria-modal={!embedded} aria-label="OFFSCRPT AI">
