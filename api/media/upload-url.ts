...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const folder = ['profile', 'articles', 'posts', 'videos', 'attachments', 'answers', 'discussion-replies', 'carousel', 'site', 'product-gallery'].includes(requestedFolder) ? requestedFolder : 'users';
